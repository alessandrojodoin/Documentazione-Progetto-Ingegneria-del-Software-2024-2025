...
\chapter{Specifica dei Requisiti}
    ...
    \section{Requisiti di Sistema}
        ...
        \subsection{Personas}
            ...
            \subsubsection{Analisi delle Personas}
            Dopo un'accurata analisi delle Personas, è stato evidente che sono necessarie implementazioni aggiuntive al sito. \newline
            Juan Bandidos, non avendo praticità con la lingua, rende nota la necessità di un'interfaccia intuitivamente navigabile, anche senza che l'utente conosca perfettamente la lingua italiana. Di conseguenza, sono state introdotte icone per facilitare la navigazione.\newline
            Inoltre, sempre grazie alla Persona di Juan Bandidos, è stata introdotta la possibilità di effettuare visite in remoto per gli immobili.\newline
            ...
            Infine, grazie alla Persona di Gustavo Panini, prendendo in considerazione la necessità di attrezzature particolari dovute a difficoltà motorie,  è stato reso obbligatorio un tag che specifica se un determinato immobile è dotato di strutture per disabili o meno, consentendo una ricerca mirata.\newline
